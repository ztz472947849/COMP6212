...
delta2925 = blsdelta(prices2925, 2925, 0.06, t+0.0001, volatility,0);
call2925 = call / 2925;
...
delta3025 = blsdelta(prices3025, 3025, 0.06, t+0.0001, volatility,0);
call3025 = call / 3025;
...
delta3125 = blsdelta(prices3125, 3125, 0.06, t+0.0001, volatility,0);
call3125 = call / 3125;
...
delta3225 = blsdelta(prices3225, 3225, 0.06, t+0.0001, volatility,0);
call3225 = call / 3225;
...
%delta3325 = blsdelta(call, 3325, 0.06, t, volatility);
delta3325 = blsdelta(prices3325, 3325, 0.06, t+0.0001, volatility,0);
...
plot_mesh(actual_prices, times, bls_deltas);
xlabel('S/X');
ylabel('T - t');
zlabel('delta');
